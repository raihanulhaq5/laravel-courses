                    ...
                    <li class="w-full lg:max-w-[165px]">
                        <a href="#"
                            ...
                            <img src="{{ $item->image }}" alt="{{ $item->name }}"
                                class="w-20 md:w-auto h-auto rounded-lg object-contain">
                        </a>
                    </li>
                @endforeach
            </ul>
                        ...
                        <div class="px-6 pb-5">
                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    ...
                                    <h4 class="text-sm-primary w-full leading-5 ml-2"> {{ $course->submittedBy->name }}
                                    </h4>
                                </div>
                                <div class="mt-3">
        ...
        <div class="w-full bg-update bg-no-repeat bg-cover h-[400px] py-0">
            <div class="container px-8 w-full flex flex-row justify-between items-center gap-5 mx-auto h-full">
                <div class="max-w-[579px] w-full">
                    ...
                    <p class="mt-3.5 text-base-primary"> We will be covering course reviews, comparison between the
                        best
